...
if(commonValidation.checkArcGISProduct() and  commonValidation.workspaceExists(targetWorkspace) and commonValidation.fileExists(inputFile)):
    ...
    try:
        commonGeoprocessing.createFeatureClass(targetWorkspace, outputFeatureClass, geometryType, template, hasM, hasZ, spatialRef)
        commonGeoprocessing.addFieldToFeatureClass(outputFeatureClass, outputFeatureClass, rhinoNameField, fieldType, fieldLength, fieldNullable)
    ...
    if(commonValidation.featureClassExists(outputFeatureClass)):
    ...
    print "Unable to complete creation of rhino tracking feature class:  License availability =  " + str(commonValidation.checkArcGISProduct()) + ", Workspace Existence = " + str(commonValidation.workspaceExists(targetWorkspace) ) + ", Input File = " + str(commonValidation.fileExists(inputFile))
    #arcpy.AddError("Unable to complete creation of rhino tracking feature class:  License availability =  " + str(commonValidation.checkArcGISProduct()) + ", Workspace Existence = " + str(commonValidation.workspaceExists(targetWorkspace) ) + ", Input File = " + str(commonValidation.fileExists(inputFile)))
